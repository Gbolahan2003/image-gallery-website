...
const sizes = {
  ...
  lg: 'px-10 sub_text h-9 2xl:h-10',
  full: 'w-full sub_text h-9 2xl:h-12'
}
  ...
  (
    ...
    return (
      <button
        ...
        type={type}
        className={clsx(
          'flex items-center justify-center font-semibold gap-2 transition duration-300 rounded-lg disabled:cursor-not-allowed disabled:opacity-70',
